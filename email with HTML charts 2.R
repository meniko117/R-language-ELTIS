...
msg1 <- mime_part(paste('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0
                        ...
                        <br>
                        <br>
                        <h3>Ниже приведена таблица с указанием позиций, по которым какой-либо из филиалов испытывает дефицит. Это является приоритетом в производстве.</h3>
                        ...
                        <br>
                        <br>
                        <h3>Показатели оборачиваемости для каждого филиала в месяцах. Т.е. рассчитана стоимость товаров на складе и разделена на план продаж в стоимостном выражении. Показатель ок. 1 мес- хорошо, 2 мес - критически много.</h3>
                        ...
                        <h1>Всего вам доброго, здоровья и хорошего настроения, держитесь здесь!</h1>
